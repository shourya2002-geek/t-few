...
class EncoderDecoder(LightningModule):
    ...
    def __init__(self, config, tokenizer, transformer, dataset_reader):
        ...
        self.validation_outputs = []  # Instance attribute to store validation outputs
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.validation_outputs.append(batch_output)  # Save validation step outputs
        return batch_output
    ...
    def on_validation_epoch_end(self):
        metrics = self.validation_test_shared_preparation(self.validation_outputs, self.config.dev_score_file)
